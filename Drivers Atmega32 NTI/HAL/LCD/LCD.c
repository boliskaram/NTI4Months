...
void lcd_write(uint8_t data){
	...
	MCAL_DIO_Write_Pin(Data_Port,PIN0,READ_BIT(data,PIN4));
	MCAL_DIO_Write_Pin(Data_Port,PIN1,READ_BIT(data,PIN5));
	MCAL_DIO_Write_Pin(Data_Port,PIN2,READ_BIT(data,PIN6));
	MCAL_DIO_Write_Pin(Data_Port,PIN4,READ_BIT(data,PIN7));
	LCD_send_pulse_for_update_data_cmd();
	MCAL_DIO_Write_Pin(Data_Port,PIN0,READ_BIT(data,PIN0));
	MCAL_DIO_Write_Pin(Data_Port,PIN1,READ_BIT(data,PIN1));
	MCAL_DIO_Write_Pin(Data_Port,PIN2,READ_BIT(data,PIN2));
	MCAL_DIO_Write_Pin(Data_Port,PIN4,READ_BIT(data,PIN3));
	LCD_send_pulse_for_update_data_cmd();
	#endif
}
